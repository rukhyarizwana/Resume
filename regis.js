document.getElementById('btn').addEventListener('click',function(e){
    ...
    var details={
        ...
        details.fullName=document.getElementById('firstname').value
        details.mobileNumber=document.getElementById('c').value
        details.emailId=document.getElementById('e').value
...
function buildResume(details){
    ...
    document.getElementById('UG').innerHTML=details.degree
